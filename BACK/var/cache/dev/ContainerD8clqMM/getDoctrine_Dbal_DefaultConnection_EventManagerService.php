...
class getDoctrine_Dbal_DefaultConnection_EventManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.persons_photos' => ['privates', 'vich_uploader.listener.clean.persons_photos', 'getVichUploader_Listener_Clean_PersonsPhotosService', true],
            'vich_uploader.listener.remove.persons_photos' => ['privates', 'vich_uploader.listener.remove.persons_photos', 'getVichUploader_Listener_Remove_PersonsPhotosService', true],
            'vich_uploader.listener.upload.persons_photos' => ['privates', 'vich_uploader.listener.upload.persons_photos', 'getVichUploader_Listener_Upload_PersonsPhotosService', true],
        ], [
            ...
            'vich_uploader.listener.clean.persons_photos' => '?',
            'vich_uploader.listener.remove.persons_photos' => '?',
            'vich_uploader.listener.upload.persons_photos' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.persons_photos'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.persons_photos'], [['postFlush'], 'vich_uploader.listener.remove.persons_photos'], [['prePersist'], 'vich_uploader.listener.upload.persons_photos'], [['preUpdate'], 'vich_uploader.listener.upload.persons_photos']]);
    }
}
