...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\AdministratorsCrudController' => 'getAdministratorsCrudControllerService',
            'App\\Controller\\Admin\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\Admin\\PersonCrudController' => 'getPersonCrudControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.persons_photos' => 'getSmartUniqueNamer_PersonsPhotosService',
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.administrators'] ?? $container->load('getSecurity_User_Provider_Concrete_AdministratorsService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'persons_photos' => [
                    'uri_prefix' => '/upload/persons_photos',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/upload/persons_photos'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.persons_photos',
                        'options' => [
